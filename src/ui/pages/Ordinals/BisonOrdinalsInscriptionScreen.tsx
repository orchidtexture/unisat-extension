...
export default function BisonOrdinalsInscriptionScreen() {
  ...
  return (
    <Layout>
      ...
      <Content>
        <Column>
          <Text
            text={isUnconfirmed ? 'Inscription (not confirmed yet)' : `Inscription  (bison) ${inscription.inscriptionNumber}`}
            preset="title-bold"
            textCenter
          />
          <Row justifyCenter>
          ...
          <Row fullX>
            ...
            )}
            {
              <Button
                ...
                onClick={(e) => {
                  dispatch(transactionsActions.reset());
                  navigate('SendBisonOrdinalsInscriptionScreen', { inscription });
                }}
              />
            }
          </Row>
