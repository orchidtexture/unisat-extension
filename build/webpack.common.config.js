    ...
    if (preProcessor) {
      ...
      if (preProcessor === 'less-loader') {
        preProcessorOptions = {
          ...
          lessOptions: {
            modifyVars: {
              'primary-color': '#6fee8d',
              'primary-color-active': '#2E444E',
              'input-icon-hover-color': '#FFFFFF',
              'component-background': '#030B0E',
              'select-dropdown-bg': '#10171A',
              ...
              'layout-header-background': '#10171A',
